...
public:
    ...
    wl_status_t begin();
    wl_status_t begin(const std::string &ssid, const std::string &passphrase, int32_t channel=0, const uint8_t *bssid=nullptr, bool connect=true);
...
protected:
    static constexpr char TAG[] = {"WifiSTA"};
