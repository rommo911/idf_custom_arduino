...
public:
    ...
    // scan result
    bool getNetworkInfo(uint8_t networkItem, std::string &ssid, uint8_t &encryptionType, int32_t &RSSI, uint8_t *&BSSID, int32_t &channel);
...
protected:
    static constexpr char TAG[] = {"WiFiScanClass"};
